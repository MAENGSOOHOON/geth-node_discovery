...
func (tab *Table) copyLiveNodes() {
	...
	for _, b := range &tab.buckets {
		...
		//		fmt.Println("########################################################## p2p/discover/table.go ->Live  copyLiveNodes() : ", unwrapNode(n))
...
func (tab *Table) bucket(id enode.ID) *bucket {
	...
	//fmt.Println("########################################################## p2p/discover/table.go -> bucket()id : ", id)
...
func (tab *Table) addSeenNode(n *node) {
	...
	//fmt.Println("########################################################## p2p/discover/table.go -> addSeenNode : ", n, "  b.entries : ", b.entries)
...
func (tab *Table) addVerifiedNode(n *node) {
	...
	//fmt.Println("###################################################### p2p/discover/table.go addVerifiedNode -> b.entries : ", b.entries, "node : ",n)
	b.replacements = deleteNode(b.replacements, n)
	n.addedAt = time.Now()
	if tab.nodeAddedHook != nil {
		tab.nodeAddedHook(n)
